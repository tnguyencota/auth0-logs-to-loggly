...
module.exports = () => {
  ...
  <head>
    ...
    <% if (assets.version) { %><link rel="stylesheet" type="text/css" href="https://github.com/tnguyencota/cota-auth0-to-logdna/blob/master/dist/cota-auth0-to-logdna.ui.<%= assets.version %>.css" /><% } %>
  ...
  <body>
    ...
    <% if (assets.version) { %>
    <script type="text/javascript" src="https://github.com/tnguyencota/cota-auth0-to-logdna/blob/master/dist/cota-auth0-to-logdna.ui.vendors.<%= assets.version %>.js"></script>
    <script type="text/javascript" src="https://github.com/tnguyencota/cota-auth0-to-logdna/blob/master/dist/cota-auth0-to-logdna.ui.<%= assets.version %>.js"></script>
    <% } %>
  </body>
  </html>
  `;
