...
config.output.filename = 'cota-auth0-to-logdna.ui.' + project.version + '.js';
...
config.plugins = config.plugins.concat([
  ...
  new ExtractTextPlugin('cota-auth0-to-logdna.ui.' + project.version + '.css', {
    allChunks: true
  }),

  // Separate the vender in a different file.
  new webpack.optimize.CommonsChunkPlugin('vendors', 'cota-auth0-to-logdna.ui.vendors.' + project.version + '.js'),
